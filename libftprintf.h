...
/*   Updated: 2020/01/28 11:28:44 by rde-vrie      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
const char		*type(const char *fmt, va_list ap, t_conv *conv, int *result);
...
void			ft_no_flag(t_conv *conv, int len, char *s, int *result);
void			ft_dash_int(t_conv *conv, int len, char *s, int *result);
...
void			ft_write(char conv, int len, int *result);
/*
** LIBFT functions
*/
char			*ft_itoa(int n);
